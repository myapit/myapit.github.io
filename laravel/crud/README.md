...
After that, open company migration  file inside laravel-crud-app/database/migrations/ directory. And then update the function up() with the following code:
```
public function up()
{
...
<head>
    <meta charset="UTF-8">
    <title>Laravel  CRUD APP Tutorial Example</title>
    ...
    <div class="container mt-2">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-left">
                    <h2>Laravel CRUD Example Tutorial</h2>
                </div>
...
<head>
    <meta charset="UTF-8">
    <title>Add Company Form - Laravel CRUD APP </title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
...
<head>
    <meta charset="UTF-8">
    <title>Edit Company Form - Laravel CRUD APP Tutorial</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
